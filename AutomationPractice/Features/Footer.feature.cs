...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("User can open links under My Acount Information section")]
        ...
        public virtual void UserCanOpenLinksUnderMyAcountInformationSection(string link, string page, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User can open links under My Acount Information section", exampleTags);
#line 22
this.ScenarioSetup(scenarioInfo);
#line 23
...
#line 26
 testRunner.When(string.Format("user clicks on \'{0}\' under My Account section", link), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 27
 testRunner.Then(string.Format("correct \'{0}\' under My Account section is displayed", page), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
